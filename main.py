class Mahasiswa():
  pass
#Penambahan fungsi perhitungan nilai akhir mahasiswa
def fungsi_total_nilai(var_harian, var_uts, var_uas) :
    var_harian = int(var_harian) * 0.4
    var_uts = int(var_uts) * 0.4
    var_uas = int(var_uas) * 0.5
...
print("==========Total Nilai==========")
print("Total nilai : ",var_total)

#Pemanggilan Fungsi Percabangan
print("Indikator nilai : ", fungsi_percabangan(var_total))
